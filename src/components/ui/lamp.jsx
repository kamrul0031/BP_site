    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[20rem] bg-gradient-conic from-transparent via-transparent to-blue-700 text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <div
          className="absolute inset-auto z-50 h-36 w-[20rem] -translate-y-1/2 rounded-full bg-red-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-red-500 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "5rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5  -translate-y-[7rem] bg-red-300 "></motion.div>
