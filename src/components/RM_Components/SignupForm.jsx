...
export function SignupFormDemo() {
  ...
  return (
    (<div
      className="max-w-md w-full mx-auto rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
        Welcome to Binary Point
      </h2>
      <span className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Sign up & Become a Binary Bit <br /> <b><p className="text-red-500">* Submitting a pointless signup may result in penalties</p></b>
      </span>
      <form className="my-8" onSubmit={handleSubmit}>
        <div
          ...
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Binary" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" placeholder="Bit" type="text" />
          </LabelInputContainer>
        </div>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Email Address</Label>
          <Input id="email" placeholder="email@binarypoint.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-8">
          <Label htmlFor="twitterpassword">Contact Number</Label>
          <Input id="twitterpassword" placeholder="+880 1234567890" type="twitterpassword" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
